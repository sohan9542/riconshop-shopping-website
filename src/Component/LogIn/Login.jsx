...
const Login = (props) => {
    ...
    const { setIsLogIn, setUserInfo, isLogIn, isSignOut, setIsSignOut } = props;
    function setme(e, user) {
        setIsLogIn(e)
        setUserInfo(user)
    }

    const signInWithGogle = (e) => {
        e.preventDefault()
        const auth = getAuth();
            ...
            <div className={cls.login}>
                <div className={cls.container}>
                    <div className={cls.loginForm}>
                       {isSignOut &&  <div className={cls.loginOrLogOutInfo}>
                            <h5>Log Out SuccessFully!</h5>
                        ...
                        {isLogIn ?
                            ...
                            <form onSubmit={(e) => handleSubmit(e)}>
                                ...
                                <input type="email" name="email" id="" required onBlur={(e) => handleUserEmail(e.target.value)} />
                                <label htmlFor="password">Password *</label>
                                <input type="password" name="password" id="" required onBlur={(e) => handleUserpassword(e.target.value)} />
                                <button type="submit">Log In</button>
                                <div style={{ border: '1px solid rgba(0,0,0,0.1)' }}></div>
                                <button onClick={(e) => signInWithGogle(e)}>Log in With Gogle</button>
